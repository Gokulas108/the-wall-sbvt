        ...
        <div className="mt-6">
          ...
          >
            <table className="w-full text-sm">
              ...
              <tbody>
                {receipt.allocations.map((row, index) => (
                  <tr
                    key={`${row.block_id}-${index}`}
                    style={{
                      borderTop:
                        index === 0
                          ? "none"
                          : "1px solid rgba(228,180,121,0.14)",
                    }}
                  >
                    <td className="px-3 py-2" style={{ color: "#fff5e7" }}>
                      {row.block_id}
                    </td>
                    <td
              ...
              <tfoot style={{ background: "rgba(255,246,233,0.06)" }}>
                <tr>
                  <td
